                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/group.GroupsDate"
                                        }
                                    }
                                }
                            ]
        ...
        "/groups/ApplyJoin/:id": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "群聊密码 判断该群是否需要密码 is_pwd 字段",
                        "name": "name",
                        "in": "formData"
                    }
                ],
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/im_groups.ImGroups"
                                        }
                                    }
                                }
                            ]
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/group_message.ImGroupMessages"
                                            }
                                        }
                                    }
                                }
        ...
        "/messages/private": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "频道类型 1.私聊 2.频道 3.广播",
                        "name": "channel_type",
                        "in": "formData",
                        "required": true
                    },
    ...
    "definitions": {
        ...
        "group.GroupsDate": {
            ...
            "properties": {
                "group_users": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/im_group_users.ImGroupUsers"
                    }
                },
                "groups": {
                    "$ref": "#/definitions/group.ImGroups"
                }
            }
        },
        "group.ImGroups": {
        ...
        "group_message.ImGroupMessages": {
            ...
            "properties": {
                ...
                "users": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/group_message.ImUsers"
                        }
                    ]
                }
            }
        },
        "group_message.ImUsers": {
            "type": "object",
            "properties": {
                "avatar": {
                    "description": "头像",
        ...
        "im_group_users.ImGroupUsers": {
            ...
            "properties": {
                ...
                "users": {
                    "$ref": "#/definitions/im_group_users.ImUsers"
                }
            }
        },
        "im_group_users.ImUsers": {
            "type": "object",
            "properties": {
                "age": {
                    "type": "integer"
        ...
        "im_sessions.ImSessions": {
            ...
            "properties": {
                ...
                "groups": {
                    "$ref": "#/definitions/im_sessions.ImGroups"
                },
                "id": {
                    "description": "会话表",
                    "type": "integer"
